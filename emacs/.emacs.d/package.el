...
(with-eval-after-load "ispell"
  ...
  (setq ispell-dictionary "de_AT,de_DE,en_GB,en_US")
...
(use-package markdown-mode
  ...
  :bind (:map markdown-mode-map
         ...
         ("S-<right>"  . #'markdown-demote-list-item)
         ("S-<left>"   . #'markdown-promote-list-item))
  :config
  (evil-make-overriding-map markdown-mode-map 'insert)
...
(defun rpo/screen (setting)
  ...
  (interactive
   (list (completing-read "Setting (1|2|3|4): " '("1" "2" "3" "4") nil t)))
